...
public class Page {
    ...
    private static final String ERROR_SESSION_KEY = "message_error";
    ...
    public void putError(HttpSession httpSession, String error_message) {
        httpSession.setAttribute(ERROR_SESSION_KEY, error_message);
    }
}
